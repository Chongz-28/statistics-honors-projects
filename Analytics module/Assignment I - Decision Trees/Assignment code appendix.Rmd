...
$\bullet$ **model 1**: Full model.
\newline
$\bullet$ **model 2**: SalePrice~1
\newline
$\bullet$ **model 3**: SalePrice ~ BsmtQual + CentralAir + KitchenQual + FireplaceQu +                           GarageFinish + MSZoning + OverallQual + YearBuilt + YearRemodAdd +                        TotalBsmtSF + GrLivArea + FullBath + TotRmsAbvGrd + GarageArea
\newline
$\bullet$ **model 4**: SalePrice ~ BsmtQual + CentralAir + KitchenQual + YearRemodAdd +                          TotalBsmtSF + GrLivArea + GarageArea + MSZoning + OverallQual +                           GarageFinish
\newline
